package com.example.gamefreakfrank.conversion;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addItemsToUnitTypeSpinner()
    {
        ...
        ArrayAdapter<CharSequence> unitTypeSpinnerAdapter = ArrayAdapter.createFromResource(this, R.array.conversion_types,
    ...
    public void updateUnitTypesUsingTsp(Quantity.Unit currenUnit)
    {
